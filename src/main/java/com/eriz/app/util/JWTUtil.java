...
public class JWTUtil {
    ...
    public static void verify(String token, String userId, String secret) {
        try {
            ...
            throw new ErizException(EnumErrorCode.apiAuthorizationExpired.getMsg());
    ...
    public static String sign(String userId, String secret, long expire) {
        try {
            ...
            throw new ErizException(EnumErrorCode.apiAuthorizationSignFailed.getCodeStr());
        }
    }
